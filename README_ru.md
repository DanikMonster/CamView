...
- **Pinggy (`*.pinggy.link` / `*.pinggy.net`)**: автоматический HTTPS-туннель в 1 клик через официальный SDK `@pinggy/pinggy` без лишней настройки (на бесплатном тарифе генерирует случайный URL; свой поддомен 4-го уровня `.a.pinggy.link` доступен с Pro-аккаунтом).
