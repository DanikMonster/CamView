...
- **Pinggy / Свой URL**: возможность указать свой персональный домен или туннель Pinggy.
...
| **⚡ Pinggy / Свой URL** | Весь мир (Интернет) | Свой домен или туннель | `https://*.a.free.pinggy.link` | HTTPS провайдера |
